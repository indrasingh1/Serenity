...
(function (SerenityProject) {
    ...
    })(Administration = SerenityProject.Administration || (SerenityProject.Administration = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    var Administration;
    (function (Administration) {
...
(function (SerenityProject) {
    ...
    })(BasicSamples = SerenityProject.BasicSamples || (SerenityProject.BasicSamples = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SerenityProject.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = SerenityProject.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SerenityProject.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (SerenityProject) {
    ...
    })(Common = SerenityProject.Common || (SerenityProject.Common = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    var Common;
...
(function (SerenityProject) {
    ...
    })(Membership = SerenityProject.Membership || (SerenityProject.Membership = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    var Membership;
...
(function (SerenityProject) {
    ...
    })(Northwind = SerenityProject.Northwind || (SerenityProject.Northwind = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    var Northwind;
...
(function (SerenityProject) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'SerenityProject.Northwind.Gender', 'SerenityProject.Northwind.Entities.Gender');
    })(Northwind = SerenityProject.Northwind || (SerenityProject.Northwind = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
...
(function (SerenityProject) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'SerenityProject.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = SerenityProject.Northwind || (SerenityProject.Northwind = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
...
(function (SerenityProject) {
    ...
    })(Authorization = SerenityProject.Authorization || (SerenityProject.Authorization = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    var Administration;
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        }(SerenityProject.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(SerenityProject.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(SerenityProject.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        }(SerenityProject.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SerenityProject.Common.ReportHelper.execute({
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SerenityProject.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SerenityProject.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SerenityProject.Northwind.OrderDialog();
                        ...
                        var chai = SerenityProject.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SerenityProject.Northwind.EmployeeRow.getLookup().items
        ...
        }(SerenityProject.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SerenityProject.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        }(SerenityProject.Northwind.OrderDialog));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    SerenityProject.Northwind.CategoryService.Retrieve({
        ...
        }(SerenityProject.Northwind.CategoryDialog));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        }(SerenityProject.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(SerenityProject.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new SerenityProject.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SerenityProject.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SerenityProject.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    SerenityProject.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SerenityProject.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SerenityProject.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SerenityProject.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SerenityProject.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SerenityProject.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SerenityProject.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return SerenityProject.LanguageList.getValue();
            };
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        }(SerenityProject.Northwind.SupplierDialog));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(SerenityProject.Northwind.SupplierGrid));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SerenityProject.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SerenityProject.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SerenityProject.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SerenityProject.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SerenityProject.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SerenityProject.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SerenityProject.Northwind.CustomerDialog));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        }(SerenityProject.Northwind.CustomerGrid));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = SerenityProject.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(SerenityProject.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SerenityProject.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new SerenityProject.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(SerenityProject.Northwind.OrderDetailDialog));
...
(function (SerenityProject) {
    ...
    (function (Northwind) {
        ...
        }(SerenityProject.Common.GridEditorBase));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        }(SerenityProject.Northwind.OrderDetailsEditor));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SerenityProject.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SerenityProject.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SerenityProject.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SerenityProject.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SerenityProject.BasicProgressDialog();
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        ...
        }(SerenityProject.Common.BulkServiceAction));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SerenityProject.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SerenityProject.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SerenityProject.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SerenityProject.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SerenityProject.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SerenityProject.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SerenityProject.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (SerenityProject) {
    ...
    SerenityProject.SelectableEntityGrid = SelectableEntityGrid;
})(SerenityProject || (SerenityProject = {}));
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SerenityProject.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SerenityProject.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SerenityProject.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(SerenityProject.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = SerenityProject.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SerenityProject.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SerenityProject.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SerenityProject.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SerenityProject.Northwind.ProductService.baseUrl; };
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SerenityProject.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SerenityProject.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SerenityProject.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return SerenityProject.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (SerenityProject) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SerenityProject.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SerenityProject.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SerenityProject.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (SerenityProject) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SerenityProject.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SerenityProject.LanguageList || (SerenityProject.LanguageList = {}));
})(SerenityProject || (SerenityProject = {}));
...
(function (SerenityProject) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('SerenityProject');
        Serenity.EntityDialog.defaultLanguageList = SerenityProject.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = SerenityProject.ScriptInitialization || (SerenityProject.ScriptInitialization = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    ...
    SerenityProject.BasicProgressDialog = BasicProgressDialog;
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    var DialogUtils;
    ...
    })(DialogUtils = SerenityProject.DialogUtils || (SerenityProject.DialogUtils = {}));
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    var Common;
...
(function (SerenityProject) {
    ...
    SerenityProject.StaticTextBlock = StaticTextBlock;
})(SerenityProject || (SerenityProject = {}));
var SerenityProject;
(function (SerenityProject) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SerenityProject.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=SerenityProject.Web.js.map